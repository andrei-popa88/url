...
class ParserTest extends TestCase
{
    public function test_should_throw_malformed_exception()
    {
        ...
        new Parser(''); // pass in a malformed url
    }
    ...
    public function test_should_throw_schema_not_supported_exception()
    {
        ...
        new Parser('news:comp.infosystems.www.servers.unix');
    }

    public function test_should_be_instance_of_path_bag()
    {
        $parser = new Parser('https://john.doe@www.example.com:123/forum/questions/?tag=networking&order=newest#top');
    ...
    {
        $parser = new Parser('http://john.doe@www.example.com:123/forum/questions/?tag=networking&order=newest#top');
    ...
    {
        $parser = new Parser('mailto:John.Doe@example.com');
    ...
    {
        $parser = new Parser('http://www.example.com:123/forum/questions/?tag=networking&order=newest#top');
    ...
    {
        $parser = new Parser('http://www.example.com/forum/questions/?tag=networking&order=newest#top');
    ...
    {
        $parser = new Parser('http://john.doe@www.example.com:123/forum/questions/?tag=networking&order=newest#top#test');
    ...
    {
        $parser = new Parser('http://john.doe@www.example.com:123/forum/questions/?tag=networking&order=newest');
    ...
    {
        $parser = new Parser('http://www.example.com:123/forum/questions/?tag=networking&order=newest#top#test');
    ...
    {
        $parser = new Parser('http://john.doe:password@www.example.com:123/forum/questions/?tag=networking&order=newest#top#test');
    ...
    {
        $parser = new Parser('http://john.doe@www.example.com/forum/questions/?tag=networking&order=newest#top#test');
