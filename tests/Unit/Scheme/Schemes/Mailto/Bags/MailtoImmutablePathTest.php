...
class MailtoImmutablePathTest extends TestCase
{
    ...
    public function testGettersEmptyUrl()
    {
        ...
        $this->assertEquals(null, $mailto->firstInPath());
        $this->assertEquals(null, $mailto->lastInPath());
    ...
    public function testGettersNotEmptyUrl()
    {
        ...
        $this->assertEquals('path@email.com', $mailto->firstInPath());
        $this->assertEquals('path2@email.com', $mailto->lastInPath());
        $this->assertEquals([
            'path@email.com',
            'path2@email.com'
        ], $mailto->getPath());
